...
const COMMON_EXCLUDED_MODULES: Record<string, string[]> = {
  'core/templates/pages/splash-page/splash-page.module.ts': [
    'core/tests/test-modules-mapping/lighthouse-accessibility/lighthouse-accessiblity-1.txt',
    'core/tests/test-modules-mapping/lighthouse-performance/lighthouse-performance-1.txt',
  ],
  'core/templates/pages/login-page/login-page.module.ts': [],
  'core/templates/pages/signup-page/signup-page.module.ts': [
    'core/tests/test-modules-mapping/lighthouse-accessibility/lighthouse-accessibility-2.txt',
    'core/tests/test-modules-mapping/lighthouse-performance/lighthouse-performance-2.txt',
  ],
  'core/templates/pages/admin-page/admin-page.module.ts': [
    'core/tests/test-modules-mapping/lighthouse-accessibility/lighthouse-accessibility-1.txt',
    'core/tests/test-modules-mapping/lighthouse-performance/lighthouse-performance-1.txt',
  ],
  'core/templates/pages/learner-dashboard-page/learner-dashboard-page.module.ts':
    [
      'core/tests/test-modules-mapping/lighthouse-accessibility/lighthouse-accessibility-1.txt',
      'core/tests/test-modules-mapping/lighthouse-performance/lighthouse-performance.txt-1',
    ],
};
