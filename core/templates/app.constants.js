 ...
 */
var constants_1 = __importDefault(require("assets/constants"));
exports.AppConstants = __assign(__assign({}, constants_1["default"]), { DEFAULT_TRANSLATIONS: {
    ...
    /* Called when the learner moves to a new card that they haven't seen
       before. */
    EDITABLE_EXPLORATION_DATA_DRAFT_URL_TEMPLATE: '/createhandler/data/<exploration_id>?apply_draft=<apply_draft>', EDITABLE_EXPLORATION_DATA_URL_TEMPLATE: '/createhandler/data/<exploration_id>', EXPLORATION_DATA_URL_TEMPLATE: '/explorehandler/init/<exploration_id>', EXPLORATION_VERSION_DATA_URL_TEMPLATE: '/explorehandler/init/<exploration_id>?v=<version>', ENTITY_TRANSLATIONS_HANDLER_URL_TEMPLATE: '/entity_translations_handler/<entity_type>/<entity_id>/<entity_version>/' +
        '<language_code>', EXPLORATION_PROGRESS_PID_URL_TEMPLATE: '/explorehandler/init/<exploration_id>?pid=<pid>', WARNING_TYPES: {
    ...
    PLACEHOLDER_OUTCOME_DEST: '/', PLACEHOLDER_OUTCOME_DEST_IF_STUCK: '/', INTERACTION_DISPLAY_MODE_INLINE: 'inline', LOADING_INDICATOR_URL: '/activity/loadingIndicator.gif', OBJECT_EDITOR_URL_PREFIX: '/object_editor_template/', 
    ...
    DEST_IF_REALLY_STUCK_FEAT_ENABLED: false, INTERACTION_NAMES: {
    ...
    MAX_UNRELATED_ACTIONS_PER_BLOCK: 4, SITE_NAME: 'Oppia.org', DEFAULT_PROFILE_IMAGE_WEBP_PATH: '/avatar/user_blue_150px.webp', DEFAULT_PROFILE_IMAGE_PNG_PATH: '/avatar/user_blue_150px.png', 
    ...
    }, CONTRIBUTOR_BADGE_INITIAL_LEVELS: [1, 10, 20, 50, 100, 200, 300, 400, 500], CONTRIBUTOR_CERTIFICATE_LOGO: '/assets/images/contributor_dashboard/oppia-logo.jpg' });
